...
const closeModal = () => {
    ...
    return(
        <div className="px-8 lg:pb-5 lg:relative overflow-hidden"> <h2 className="text-white lg:py-20 pb-6  lg:text-[120px] text-[40px] uppercase font-bold underline lg:leading-[160px] leading-[40px]">
     HOW WE WORK
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-18 mt-8">
            <div className="md:flex gap-2 group lg:mb-0 mb-5">
                ...
                <h6 className="text-white text-[18px] poppins-medium underline">{howWeWork? howWeWork[0]?.title: ''}</h6>
                <h6 className="text-white text-[16px] poppins-regular">{howWeWork? howWeWork[0]?.description: ''}</h6>
                </div>
                ...
                <div
                            ...
                            onClick={() => openModal(0)}
                            style={{
                                backgroundImage: `url(${howWeWork? howWeWork[0]?.thumbnail: ''})`,
