         ...
         {loading ? (
           ...
           <div className="flex flex-wrap md:justify-center justify-start lt:gap-12 gap-4 lg:mt-20 mt-10 px-20">
            ...
            <div className="flex items-center gap-3">
                ...
                <Rating
                    initialRating={header? header[0]?.googleReview :'0'}
                    emptySymbol={<FaRegStar />}
                    fullSymbol={<FaStar />}
                    readonly
                    className="text-[20px] text-[#00ECFB] mb-0"
                  />
                  <p className="text-white poppins-medium text-[16px] mt-[-5px]">Got {header? header[0]?.googleReview :'0'} stars</p>
                </div>
            </div>
            {/* Nexile Review */}
            <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col gap-0">
                <Rating
                    initialRating={header? header[0]?.nexileReview: '0'}
                    emptySymbol={<FaRegStar />}
                    fullSymbol={<FaStar />}
                    readonly
                    className="text-[20px] text-[#00ECFB] mb-0"
                  />
                  <p className="text-white poppins-medium text-[16px] mt-[-5px]">Got {header? header[0]?.nexileReview: '0'} stars</p>
                </div>
            </div>
            ...
            <div className="flex items-center gap-3">
                ...
                <h6 className="poppins-regular text-white text-[18px]">successful clients</h6>
                  <p className="text-white poppins-medium text-[16px] mt-[-5px]">{header? header[0]?.clients :'0'}+</p>
                </div>
            </div>
             ...
             <div className="flex items-center gap-3">
                ...
                <h6 className="poppins-regular text-white text-[18px]">experience</h6>
                  <p className="text-white poppins-medium text-[16px] mt-[-5px]">{header? header[0]?.experience:'0'}+</p>
                </div>
            </div>
